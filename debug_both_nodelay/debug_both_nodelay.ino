// hardware pins
const int button1Pin = 5;        // input pin for switch 1
const int button2Pin = 6;        // input pin for switch 2
const int ledPin = 3;            // output pin for LED 
const int vibePin = 11;           // output pin for VIBE
const int plzworkled = 13;
const int fivev = 4;
// knobs
...
if (vibeON == true && bothON == false) {
digitalWrite(plzworkled, HIGH);
Serial.println("vibeonly");
}

  // ***** handle on/off vibe pin if needed ***** only vibration
